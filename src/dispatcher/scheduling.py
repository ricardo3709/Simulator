...
def compute_schedule(veh_params: List[Union[int, float, int]], sub_sches: List[List[Tuple[int, int, int, float]]],
                     req_params: List[Union[int, int, int, float, float]],
                     system_time_sec: int) -> Tuple[list, float, List[List[Tuple[int, int, int, float]]]]:
