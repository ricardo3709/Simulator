...
system_time = init_timer() #initialize the system timer
...
def run_sim():
    ...
    while system_time < SIMULATION_DURATION:
      # 1.1. Initialize the AMoD model and print its configuration.
      print(f"\n[INFO] Running simulation using {DISPATCHER, FLEET_SIZE[0], VEH_CAPACITY[0], MAX_PICKUP_WAIT_TIME_MIN[0]}")
      ...
      print(f"[INFO] Result: total_service = {platform.main_sim_result[0]}/{platform.main_sim_result[1]} "
