...
class ConfigManager:
    def __init__(self):
        ...
        self.settings = {
            ...
            ##################################################################################
            "MAP_NAME": "Manhattan",
            "PATH_SMALLGRID_ARCS": f"{self.root_path }/SmallGridData/SmallGrid_Arcs.csv",
            "PATH_SMALLGRID_REQUESTS": f"{self.root_path }/SmallGridData/SmallGrid_Requests.csv",
            "PATH_SMALLGRID_TIMECOST": f"{self.root_path }/SmallGridData/SmallGrid_TimeCost.csv",
            "PATH_SMALLGRID_ALL_PATH_TABLE": f"{self.root_path }/SmallGridData/SmallGrid_AllPathTable.pickle",
            "NUM_NODES_SMALLGRID": 100,
            "PATH_MANHATTAN_ALL_PATH_MATRIX": f"{self.root_path }/NYC/NYC_Manhattan_AllPathMatrix.pickle",
            "PATH_MANHATTAN_ALL_PATH_TIME_MATRIX": f"{self.root_path }/NYC/NYC_Manhattan_AllPathTimeMatrix.pickle",
            "PATH_MANHATTAN_CITYARC": f"{self.root_path }/NYC/NYC_Manhattan_CityArc.pickle",
            "PATH_MANHATTAN_REQUESTS": f"{self.root_path }/NYC/NYC_Manhattan_Requests.csv",
