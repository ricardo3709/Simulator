...
class Simulator_Platform(object):
    ...
    def create_report(self):
        ...
        wrong_reqs = [req.Req_ID for req in self.reqs if req.Status == OrderStatus.PICKING and req not in self.statistic.served_requests_IDs]
        # self.create_video()
        ...
        print(f"Wrong Requests: {wrong_reqs}")
