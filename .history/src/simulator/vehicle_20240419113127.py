...
class Veh(object):
    ...
    def move_to_time(self, current_system_time:float, statistic: Statistic): 
        if len(self.schedule) == 0: #no more nodes to visit
            ...
            while self.veh_time < current_system_time: #update veh_time until it reaches current_system_time, suppose to update 0.25 per iteration. 
    ...
    def update_schedule(self, new_schedule: list):
        ...
        self.schedule = copy.deepcopy(new_schedule)
        self.target_node = self.schedule[0][0]
