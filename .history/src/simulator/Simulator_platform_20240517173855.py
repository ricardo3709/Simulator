...
class Simulator_Platform(object):
    ...
    def create_video(self):
        ...
        FILE_TYPE = '.mp4'
        # BASEDIR = osp.dirname(osp.abspath(__file__)) + '/'
        OUTPUT_NAME = str(self.config.get('FLEET_SIZE[0]')) + 'Vehs_' + str(self.config.get('VEH_CAPACITY[0]')) + 'Ppl_' + str(MAX_PICKUP_WAIT_TIME) + 'MaxWait_' + str(MAX_DETOUR_TIME) + 'MaxDetour_' + self.config.get('REBALANCER') + 'Rebalancer_' + self.config.get('DISPATCHER') + 'Dispatcher' + FILE_TYPE
