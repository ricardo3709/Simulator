...
class Simulator_Platform(object):
    ...
    def create_report(self):
        ...
        total_served_reqs_delete_duplicate = len(set(self.statistic.served_requests_IDs))
        ...
        print(f"Total Served Requests(delete duplicate): {total_served_reqs_delete_duplicate}")
