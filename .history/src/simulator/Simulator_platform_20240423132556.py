...
class Simulator_Platform(object):
    ...
    def mapping_node_to_coordinate(self, node_id):
        ...
        return (node_id % 10 * scale_factor, node_id // 10 * scale_factor)
    ...
    def create_video(self):
        ...
        for frame in vehicle_positions:
            ...
            for veh_node_id in frame:
                veh_coordinate = self.mapping_node_to_coordinate(veh_node_id) * 100 #scale the coordinate to the video size
