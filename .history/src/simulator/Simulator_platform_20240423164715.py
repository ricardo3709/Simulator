...
class Simulator_Platform(object):
    ...
    def create_video(self):
        ...
        FILE_TYPE = '.mp4'
        OUTPUT_NAME = FLEET_SIZE[0] + 'Vehs_' + VEH_CAPACITY + 'Ppl_' + MAX_PICKUP_WAIT_TIME + 'MaxWait_' + MAX_DETOUR_TIME + 'MaxDetour_' + REBALANCER + 'Rebalancer_' + DISPATCHER + 'Dispatcher' + FILE_TYPE
