...
class Simulator(object):
    ...
    def __init__(self, simulation_start_time_stamp: float):
        ...
        self.rejected_reqs = []
        self.num_of_generate_req_for_nodes_dict_movingAvg = {i: deque(maxlen=12) for i in range(1, NUM_NODES_MANHATTAN+1)} # {node_id: generate_req} used in reward calculation
        self.num_of_rejected_req_for_nodes_dict_movingAvg = {i: deque(maxlen=12) for i in range(1, NUM_NODES_MANHATTAN+1)} # {node_id: rejected_req} used in reward calculation
