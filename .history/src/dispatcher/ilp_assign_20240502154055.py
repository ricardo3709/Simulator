...
def anticipatory_cost(veh_trip_pairs: list):
    # new req
    PU_position = next((index for index, node in enumerate(veh_trip_pairs) if node[-1] == 'NEW_PU'), None)
    t_wait_new = compute_schedule_time_cost()
    pass
