...
def insert_request_into_schedule(schedule: list, request: Req, PU_node_position: int, DO_node_position: int):
    ...
    # new_schedule = schedule # try shallow copy
    ...
    new_schedule_part1.append(PU_node).extend(new_schedule_part2)

    new_schedule_part1 = new_schedule[:DO_node_position]
    new_schedule_part2 = new_schedule[DO_node_position:]
    new_schedule_part1.append(DO_node).extend(new_schedule_part2)
