...
def compute_table():
    ...
    # Tried to save the path table as a csv file, but unnecessary. Save everything as a pickle file instead.
    ...
    #         path_table.loc[origin_node, des_node] = path #There is a bug here, need to fix
